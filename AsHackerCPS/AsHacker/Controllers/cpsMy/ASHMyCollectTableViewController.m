...
//    [params setObject:@"1" forKey:@"flag"];
    ...
    [MOMNetWorking asynRequestByMethod:@"storeList.do" params:params publicParams:MOMNetPublicParamUserId|MOMNetPublicParamToken callback:^(id result, NSError *error) {
