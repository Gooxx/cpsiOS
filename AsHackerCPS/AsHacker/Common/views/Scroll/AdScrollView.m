...
//    [_imageNameArray[0] objectForKey:@"img"];
//    [CacheUtil loadImage:[_imageNameArray[0] objectForKey:@"img"] completion:^(UIImage *img) {
//        _leftImageView.image = img;
//    }];
//    [CacheUtil loadImage:[_imageNameArray[1] objectForKey:@"img"] completion:^(UIImage *img) {
//        _centerImageView.image = img;
//    }];
//    [CacheUtil loadImage:[_imageNameArray[2] objectForKey:@"img"] completion:^(UIImage *img) {
//         _rightImageView.image = img;
//    }];
//    _leftImageView.image = [UIImage imageNamed:[_imageNameArray[0] objectForKey:@"img"]];
//    _centerImageView.image = [UIImage imageNamed:[_imageNameArray[1] objectForKey:@"img"]];
//    _rightImageView.image = [UIImage imageNamed:[_imageNameArray[2] objectForKey:@"img"]];
}
...
- (void)setAdTitleArray:(NSArray *)adTitleArray withShowStyle:(AdTitleShowStyle)adTitleStyle
{
    ...
    _leftAdLabel.text = [_adTitleArray[0] objectForKey:@"mes"];
    _centerAdLabel.text = [_adTitleArray[1] objectForKey:@"mes"];//_adTitleArray[1];
    _rightAdLabel.text = [_adTitleArray[2] objectForKey:@"mes"];//_adTitleArray[2];
