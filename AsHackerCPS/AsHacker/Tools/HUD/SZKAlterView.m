...
//        UIView *vv =[[UIView alloc]initWithFrame:CGRectMake(0, 0, self.bounds.size.width, 420)];
//        vv.backgroundColor = [UIColor whiteColor];
//        [self addSubview:vv];
//        //标题
//        UIImageView *imageView = [[UIImageView alloc]initWithFrame:CGRectMake(0, 0, self.bounds.size.width, 100)];
//        
//        [imageView setImage:[UIImage imageNamed:@"背景"]];
//        [vv addSubview:imageView];
        
//                _titleLb=[[UILabel alloc]initWithFrame:CGRectMake(0, 100, self.bounds.size.width, 50)];
//                _titleLb.textAlignment=NSTextAlignmentCenter;
//                _titleLb.textColor=[UIColor blackColor];
//                [vv addSubview:_titleLb];
//        //内容
...
//                [vv addSubview:_contentLb];
//        
//        //        //取消按钮
//                _cancelBt=[[UIButton alloc]initWithFrame:CGRectMake(0, CGRectGetMaxY(vv.frame), self.bounds.size.width/2, 50)];
...
{
    SZKAlterView *alterView=[[SZKAlterView alloc]initWithFrame:CGRectMake(0, 0, 250, 450)];
//     SZKAlterView *alterView=[[[NSBundle mainBundle] loadNibNamed:@"ASHAlertView" owner:self options:nil] firstObject];
...
//     [alterView.cancelBt addTarget:self action:@selector(cancelBtClick) forControlEvents:UIControlEventTouchUpInside];
